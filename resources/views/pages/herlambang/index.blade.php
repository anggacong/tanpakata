...
<body class=" overflow-x-hidden">
    ...
    <section id="cover">
        <div class="">
            <div id="open" class="z-[9999] w-screen h-screen fixed left-0  top-0 bg-cover bg-center" style="background-image: url('{{asset('img/herlambang/cover.jpg')}}')">
    ...
    <main class="container-lg md:relative md:flex md:flex-wrap md:justify-end ">
        {{-- Image Left Fixed --}}
        <section id="imageLeft" class="bg-slate-600 bg-blend-overlay w-2/3 z-50 h-screen fixed left-0 top-0 bottom-0 bg-cover bg-center hidden md:block " style="background-image: url('{{asset('img/herlambang/herla-5.JPG')}}')">
        ...
        <section class="w-full md:w-1/3">
            ...
            <section id="section-bride ">
                <div class="w-full bg-[#1c2f36] overflow-hidden">
                    <div class="flex flex-wrap justify-center">
                        ...
                        <div class="w-full">
                            <h1 data-aos="fade-up" data-aos-duration="2000" class="font-yellowMagician font-semibold text-4xl text-center text-textluxx-0 mb-3">BRIDES </h1>
                            <div class="px-5 text-center mb-5">
                                <h1 data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins font-bold mb-2 mt-5 text-lg">Herlambang ( Bembeng )</h1>
                                <p data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins  text-base">Anak Pertama Dari :</p>
                                <p data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins font-light text-base mb-5">Alm Bapak Sulaiman Dan Ibu Masinem</p>
                                <div data-aos="fade-up" data-aos-duration="2000">
                                    <a href="https://www.instagram.com/herlambang.07/" class="p-3 rounded-md bg-[#A0ADB3] text-primaryluxx-0 font-poppins font-medium hover:bg-[#8D9BA4]">
            ...
            <section id="section-groom ">
                <div class="w-full bg-[#1c2f36] overflow-hidden">
                    <div class="flex flex-wrap justify-center">
                        ...
                        <div class="w-full">
                            <h1 data-aos="fade-up" data-aos-duration="2000" class="font-yellowMagician font-semibold text-4xl text-center text-textluxx-0 mb-3">GROOM </h1>
                            <div class="px-5 text-center mb-5">
                                <h1 data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins font-bold mb-2 mt-5 text-lg">Julis Agustini, SE</h1>
                                <p data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins  text-base">Anak Pertama Dari :</p>
                                <p data-aos="fade-up" data-aos-duration="2000" class="text-textluxx-0 font-poppins font-light text-base mb-5">Bapak Suparto Dan Ibu Sugiyem</p>
                                <div class="pb-10" data-aos="fade-up" data-aos-duration="2000">
                                    <a href="https://www.instagram.com/julis_agustini03/" class="p-3 rounded-md bg-[#A0ADB3] text-primaryluxx-0 font-poppins font-medium hover:bg-[#8D9BA4]">
                                        <i class="fab fa-instagram mr-2 text-lg"></i><span>Instagram</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex flex-wrap">
                            ...
                            <div class="bg-[#9FAEB3] w-3/4  p-3">
                                ...
                                <div class=" pb-5 font-poppins text-primaryluxx-0">
                                    ...
                                    <a href="#" class="rounded-md bg-primaryluxx-0 p-3 font-medium text-base text-white hover:bg-[#8D9BA4]" target="_blank">Google Maps</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="section galery">
                <div class=" bg-primaryluxx-0">
                    <div class="p-5 flex flex-wrap overflow-x-hidden">
                        <div class="w-full">
                            <h1 data-aos="fade-left" data-aos-duration="2000" class="text-end font-yellowMagician text-5xl text-primaryluxx-0 text-bold ">OUR <span class="text-end mr-5 font-saint text-5xl text-primaryluxx-0leading-7 mb-5">Galery</span></h1>
            ...
            {{-- <section id="section-lovestory">
                ...
                <div >
                    <h1  data-aos="fade-up" data-aos-duration="2000" class="font-poppins text-xl text-center font-bold text-primaryluxx-0mt-20">20 April 2020</h1>
                    <p  data-aos="fade-up" data-aos-duration="2000" class="font-poppins text-sm text-center font-medium text-primaryluxx-0mt-3">Pertama kali kami berjumpa saat sedang menjalankan studi di perguruan tinggi, saat itu kami hanya teman biasa.</p>
                    <h1  data-aos="fade-up" data-aos-duration="2000" class="font-poppins text-xl text-center font-bold text-primaryluxx-0mt-5">25 April 2022</h1>
                    <p  data-aos="fade-up" data-aos-duration="2000" class="font-poppins text-sm text-center font-medium text-primaryluxx-0mt-3">Dia memantapkan diri untuk langsung bertemu kedua orangtua ku dan melamarkan ku saat itu juga.</p>
                    <h1  data-aos="fade-up" data-aos-duration="2000" class="font-poppins text-xl text-center font-bold text-primaryluxx-0mt-5">31 April 2023</h1>
            ...
            <section id="section-wedding-gif">
                <div class="p-5 bg-primaryluxx-0 text-textluxx-0">
                    ...
                    <p data-aos="fade-up" data-aos-duration="2000" class="text-center font-poppins text-sm text-primaryluxx-0font-medium">Bagi Bapak/Ibu/Saudara/i yang ingin mengirimkan hadiah pernikahan dapat melalui virtual account di bawah ini:</p>
            ...
            <section id="section-thanks">
                <div class="p-5 bg-[#2c434b]">
                    ...
                    <p data-aos="fade-up" data-aos-duration="2000" class="text-center font-poppins text-sm text-white">Merupakan suatu kebahagiaan dan kehormatan bagi kami, apabila Bapak/Ibu/Saudara/i, berkenan hadir dan memberikan do’a restu kepada kami.</p>
                </div>
            </section>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 732 732">
                        ...
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="Layer_1-2" data-name="Layer 1">
                                ...
                                <path class="cls-play-2" d="M270,210.19V524.44c.07,6.17,1.19,13,5.78,15.77,7.63,4.53,20.78-4.86,24.22-7.21,21.44-14.68,127.42-72.2,278.92-152.87L293.53,191.89A16.51,16.51,0,0,0,270,210.19Z" />
                            </g>
                        </g>
                    </svg>
                </button>
