...
<body class="overflow-hidden overflow-x-hidden">
    ...
    <section id="cover">
        <div class="">
            <div id="open" class="z-[9999] w-screen h-screen fixed left-0 top-0 bg-cover bg-left" style="background-image: url('{{asset('img/vintadanreza/BKR_5149.jpg')}}')">
                ...
                <div class="flex flex-wrap justify-end items-end pb-36 h-screen ">
                    <div class="w-full  text-center">
                        ...
                        <h1 data-aos="zoom-in-out" data-aos-duration="3000" class="font-poppins text-5xl mb-3 font-bold text-white">Vinta & Reza</h1>
...
<main class="container-lg md:relative md:flex md:flex-wrap md:justify-end ">
    ...
    <section id="imageLeft" class="bg-slate-600 bg-blend-overlay w-2/3 z-50 h-screen fixed left-0 top-0 bottom-0 bg-cover bg-center hidden md:block "
     style="background-image: url('{{asset('img/vintadanreza/BKR_5390.jpg')}}')">
    ...
    <section class="w-full md:w-1/3">
            ...
            <section id="home-cover">
                <div class="w-full h-screen left-0 top-0 bg-cover bg-center">
                    <div id="image-container" class="relative w-full h-screen">
                        <img src="{{asset('img/vintadanreza/BKR_12.jpg')}}" class="image" />
                        <img src="{{asset('img/vintadanreza/BKR_14.jpg')}}" class="image  fadeOut" />
                            ...
                            <div class="relative">
                                <div class="flex flex-wrap items-end h-screen " style="padding-bottom:110px;">
                                    <div class="w-full text-center ">
                                        ...
                                        <h1 class="font-poppins text-5xl mb-3 font-bold text-white">Vinta & Reza</h1>
                                        <p class="font-poppins text-sm  font-bold text-white tracking-[0.20rem] ">SAVE THE DATE | 21 Agustus 2023</p>
        ...
        <section id="section-surah ">
            ...
            <div  class="absolute left-0 -top-5 w-full  opacity-10">
                ...
                <div class="relative">
                    <h1 data-aos="fade-up" data-aos-duration="2000" class="font-yellowMagician font-semibold text-5xl text-center text-primarylux-0 mb-5">V <span class="font-light">|</span> R</h1>
                    <h1 data-aos="zoom-in" data-aos-duration="2000" class="font-poppins font-semibold text-center text-lg mb-3 text-primarylux-0">Q.S Ar-Rum : 21</h1>
        ...
        <section id="section-bride ">
            ...
            <div class="flex flex-wrap ">
                <div class="relative  w-2/3 h-80 ">
                        <div data-aos="fade-right" data-aos-duration="2000" class="absolute  z-10 w-full h-80  bg-cover bg-left" style="background-image: url('{{asset('img/vintadanreza/BKR_5119.jpg')}}')"></div>
                ...
                <div data-aos="fade-right" data-aos-duration="2000" class="w-3/3 mt-2 px-5">
                    <h1  class="text-primarylux-0 font-poppins font-bold mb-2 mt-5 text-xl">Vinta Agustiana, S.Tr.Keb</h1>
                    <p  class="text-primarylux-0 font-poppins font-semibold text-base">Anak Pertama Dari :</p>
                    <p  class="text-primarylux-0 font-poppins font-light text-xs mb-5">Bapak Ansari dan Ibu Asmawati</p>
                    <a  href="https://www.instagram.com/vinta_collection/" class="p-3 rounded-md bg-primarylux-0 text-white font-poppins font-medium hover:bg-[#8D9BA4]">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-2/3">
                            <div class="relative h-80 ">
                                <div data-aos="fade-left" data-aos-duration="2000"  class="absolute z-10 w-full h-80  bg-cover bg-right" style="background-image: url('{{asset('img/vintadanreza/BKR_5152.jpg')}}')"></div>
                                <div class="absolute w-full  h-80 top-2 right-3 bg-primarylux-0 opacity-30"></div>
                            </div>
                        </div>
                    </div>
                    <div class="flex justify-end items-end">
                        <div data-aos="fade-left" data-aos-duration="2000" class="w-3/3 mt-2 px-5 text-end">
                            <h1 class="text-primarylux-0 font-poppins font-bold mb-2 mt-5 text-xl">Ns. Reza Fahlevi. S.Kep</h1>
                            <p class="text-primarylux-0 font-poppins font-semibold text-base">Anak Pertama Dari :</p>
                            <p class="text-primarylux-0 font-poppins font-light text-xs mb-5" >Bapak Muhammad Saleh dan Ibu Kurniati</p>
                        ...
                        <div class="w-full flex flex-wrap">
                            ...
                            <div class=" w-3/4 p-3">
                                ...
                                <div class=" pb-5 font-poppins text-primarymini1-0">
                                    ...
                                    <a href="https://maps.app.goo.gl/UthVaZhMMxkGzGb96" class="rounded-md bg-primarymini1-0 p-3 font-medium text-base text-white hover:text-black" target="_blank">Google Maps</a>
                                </div>
                            </div>
                        </div>
        ...
        <section id="section galery">
            <div class=" py-10 bg-[#f8f9f6]">
                <div class="p-5 flex flex-wrap overflow-x-hidden">
                    ...
                    <div  class="w-1/3">
                        <h1 data-aos="fade-left" data-aos-duration="2000" class="text-end font-yellowMagician text-3xl text-primarylux-0 text-bold ">OUR</h1>
                        <h1 data-aos="fade-left" data-aos-duration="2000" class="text-end mr-5 font-saint text-3xl text-primarylux-0 leading-7 mb-5">Galery</h1>
                    </div>
                </div>
                <div class="gallery mt-5 w-full">
                    <div class="image  grid grid-cols-1 h-[300px]">
                        <div><img src="{{asset('img/vintadanreza/BKR_5322.jpg')}}" class="object-cover w-full h-[300px]"></div>
                        <div><img src="{{asset('img/vintadanreza/BKR_5135.jpg')}}" class="object-cover w-full h-[300px]"></div>
                        <div><img src="{{asset('img/vintadanreza/BKR_5390.jpg')}}" class="object-cover w-full h-[300px]"></div>
                        <div><img src="{{asset('img/vintadanreza/BKR_5113.jpg')}}" class="object-cover w-full h-[300px]"></div>
                        
                    </div>
                    <div class="thumb h-16 grid grid-cols-3 bg-green-300">
                        <div class=""><img src="{{asset('img/vintadanreza/BKR_5322.jpg')}}" class="object-cover w-48 h-16"></div>
                        <div class=""><img src="{{asset('img/vintadanreza/BKR_5135.jpg')}}" class="object-cover w-48 h-16"></div>
                        <div class=""><img src="{{asset('img/vintadanreza/BKR_5390.jpg')}}" class="object-cover w-48 h-16"></div>
                        <div class=""><img src="{{asset('img/vintadanreza/BKR_5113.jpg')}}" class="object-cover w-48 h-16"></div>
                    </div>
                </div>
            </div> 
        </section>
        ...
        {{-- <section id="section-wedding-gif">
            <div class="p-5 bg-[#f8f9f6]">
                ...
                <div  data-aos="fade-up" data-aos-duration="2000" class="card bg-[#F4F5F0] shadow-md mt-5 p-10 rounded-lg text-center text-primarylux-0">
                    ...
                    <h2 class="font-base  font-poppins mb-4">A/N : Vinta </h2>
