...
<body class=" overflow-x-hidden">
    ...
    <section class="overflow-hidden" id="cover">
        <div class="">
            <div id="open" class="z-[9999] w-screen h-screen fixed left-0  top-0 bg-cover bg-center" style="background-image: url('{{asset('img/jemari/2.jpg')}}')">
                ...
                <div class="flex flex-wrap justify-end items-end pb-36 h-screen ">
                    <div class="w-full  text-center">
                        ...
                        <button data-aos="zoom-in-out" data-aos-duration="3000" id="buttonOpen" class="bg-[#8C806E]  rounded-sm p-3 font-poppins font-semibold text-center inline-flex items-center text-white">
    ...
    <main class="container-lg md:relative md:flex md:flex-wrap md:justify-end ">
        {{-- Image Left Fixed --}}
        <section id="imageLeft" class="bg-secondarymini1-0 bg-blend-multiply w-2/3 z-50 h-screen fixed left-0 top-0 bottom-0 bg-cover bg-center hidden md:block " style="background-image: url('{{asset('img/jemari/5.jpg')}}')">
        ...
        <section class="w-full md:w-1/3">
                                ...
                                <div class="flex flex-wrap items-end  " style="padding-bottom:10px;">
                                    <div class="w-full text-center ">
                                        ...
                                        <div class="py-8 px-14 grid grid-cols-4 gap-1  text-center">
                                            <div class=" font-poppins font-light text-black py-5 bg-white rounded-md bg-opacity-70 text-sm leading-none"><span class="font-bold" id="day">0</span>
                                                <p class="leading-none font-light text-xs">Days</p>
                                            </div>
                                            <div class=" font-poppins font-light text-black py-5 bg-white rounded-md bg-opacity-70 text-xs leading-none"><span class="font-bold" id="hour">0</span>
                                                <p class="leading-none font-light text-xs">Hours</p>
                                            </div>
                                            <div class=" font-poppins font-light text-black py-5 bg-white rounded-md bg-opacity-70 text-xs leading-none"><span class="font-bold" id="minute">0</span>
                                                <p class="leading-none font-light text-xs">Minute</p>
                                            </div>
                                            <div class=" font-poppins font-light text-black py-5 bg-white rounded-md bg-opacity-70 text-xs leading-none"><span class="font-bold" id="second">0</span>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs mb-10 text-white p-5">Segala Puji Bagi Allah SWT yang telah menjadikan hambanya hidup berpasang-pasangan. Dengan memohon Ridho, Rahmat, dan Berkah Allah SWT, kami bermaksud untuk mengundang Saudara/i dalam acara pernikahan yang kami selenggarakan.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-wrap justify-center p-10">
                        <div class="w-3/4">
                            <div class="swiper bride-swiper rounded-[30px] shadow-xl  shadow-slate-700">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide filter grayscale contrast-100 brightness-98"><img src="{{asset('img/jemari/kotak/7.jpg')}}" alt=""></div>
                    ...
                    <div class="flex flex-wrap justify-center p-10">
                        ...
                        <div class="w-3/4">
                            <div class="swiper groom-swiper rounded-[30px] shadow-xl  shadow-slate-700">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide filter grayscale contrast-100 brightness-98"><img src="{{asset('img/jemari/kotak/8.jpg')}}" alt=""></div>
            ...
            <section data-aos="fade-up" data-aos-duration="2000" class="bg-primarymini1-0 p-5" id="section-surah">
                ...
                <h1 class="font-poppins font-thin font-italic text-center text-xs text-white">Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang.</h1>
            </section>
            ...
            <section data-aos="fade-up" data-aos-duration="3000" id="our-story">
                <div class="w-full mb-10">
                    <h1 data-aos="fade-down" data-aos-duration="2000" class="text-center font-playfair text-xl text-black text-bold ">OUR <span class="text-end mr-5 font-saint text-xl text-primaryluxx-0leading-7 mb-5">Story</span></h1>
                </div>
                ...
                <div id="carousel-small" class="px-5">
                    <div style="height: 200px; width:100%;border-radius:50px 20px 50px 0;" class="swiper story-swiper">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img style="height: 200px;width:100%;object-fit:cover;" src="{{asset('img/jemari/5.jpg')}}" alt=""></div>
                            <div class="swiper-slide"><img style="height: 200px;width:100%;object-fit:cover;" src="{{asset('img/jemari/6.jpg')}}" alt=""></div>
                        </div>
                    </div>
                </div>
                <div class="w-full flex flex-wrap px-5">
                    ...
                    <div class=" w-3/4 p-3 bg-opacity-50">
                        <div class=" pb-5 font-poppins text-primarymini1-0">
                            ...
                            <h1 class="text-xs">Setelah menjalin hubungan beberapa tahun, akhirnya kami memantabkan hati untuk membawa hubungan ini ke jenjang yang lebih serius untuk hidup dan menua bersama.</h1>
            ...
            <section id="section galery">
                <div class=" bg-primarymini-1">
                    <div class="w-full mb-10 mt-10">
                        <h1 data-aos="fade-down" data-aos-duration="2000" class="text-center font-playfair text-xl text-black text-bold ">OUR <span class="text-end mr-5 font-saint text-xl text-primaryluxx-0leading-7 mb-5">Galery</span></h1>
                    </div>
            ...
            <section id="section-wedding-gif">
                <div class="p-5 bg-primarymini1-0 text-textluxx-0">
                    ...
                    <p data-aos="fade-up" data-aos-duration="2000" class="text-center font-poppins text-sm text-white font-medium">Bagi Bapak/Ibu/Saudara/i yang ingin mengirimkan hadiah pernikahan dapat melalui virtual account di bawah ini:</p>
                        ...
                        <div class="swiper thanks-swiper relative">
                            <div class="w-full  h-2/3 z-50 bottom-0 absolute bg-gradient-to-t from-[#b7b1a4] via-[#b7b1a4de] to-[#ffffff00]">
                                <div class="p-5 bottom-0 absolute">
                                    ...
                                    <p data-aos="fade-up" data-aos-duration="2000" class="text-center font-thin font-poppins text-xs mb-10 text-white">Merupakan suatu kebahagiaan dan kehormatan bagi kami, apabila Bapak/Ibu/Saudara/i, berkenan hadir dan memberikan do’a restu kepada kami.</p>
